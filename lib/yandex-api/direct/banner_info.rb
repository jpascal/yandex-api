...
module Yandex::API
  module Direct
    ...
    class ContactInfo < Base
      direct_attributes :CompanyName, :ContactPerson, :Country, :CountryCode,
                        :City, :Street, :House, :Build, :Apart, :CityCode,
                        :Phone, :PhoneExt, :IMClient, :IMLogin, :ExtraMessage,
                        :ContactEmail, :WorkTime, :OGRN
    ...
    class BannerInfo < Base
      ...
      def save
        Direct.request('CreateOrUpdateBanners', [to_hash]).first
      end
